...
{
    public class CleanSightInputDataForQueries : DWISDataWithMQTT<ConfigurationForCleanSight>
    {
        private static readonly Lazy<IReadOnlyDictionary<string, PropertyInfo>> LocalTopicPropertyMap = new(BuildTopicPropertyMap(typeof(CleanSightInputDataForQueries)));
        private static readonly Lazy<IReadOnlyDictionary<PropertyInfo, Dictionary<string, QuerySpecification>>> LocalSparQLQueries = new(BuildSparQLQueries(typeof(CleanSightInputDataForQueries)));
        private static readonly Lazy<IReadOnlyDictionary<PropertyInfo, ManifestFile>> LocalManifests = new(BuildManifests(typeof(CleanSightInputDataForQueries), "CleanSightInputData", "DrillDocs", "DWISBridge"));
        ...
        [OptionalFact(1, "downholeECD#01", Verbs.Enum.IsTransformationOutput, "movingAverageDownholeECD")]
        ...
        [OptionalFact(1, "movingAverageDownholePressure", Nouns.Enum.MovingAverage)]
        [OptionalFact(1, "downholePressure#01", Verbs.Enum.IsTransformationOutput, "movingAverageDownholePressure")]
        ...
        [SemanticFact("downholeESD#01", Verbs.Enum.IsTransformationOutput, "movingAverageDownholeESD")]
