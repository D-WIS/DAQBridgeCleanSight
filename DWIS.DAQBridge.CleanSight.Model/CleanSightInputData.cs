...
{
    public class CleanSightInputData : DWISDataWithMQTT<ConfigurationForCleanSight>
    {
        ...
        private static readonly Lazy<IReadOnlyDictionary<PropertyInfo, ManifestFile>> LocalManifests = new(BuildManifests(typeof(CleanSightInputData), "CleanSightInputData", "DrillDocs", "DWISBridge"));
